...
<body>
    ...
    <div style='display:none'>
        <form id='form-signout' method='post' action='w10_ajax_json_controller.php'>
    ...
    <script>
        ...
        $('#button-search-questions').on('click', function() {
            ...
            $.post("w10_ajax_json_controller.php",
                {
                ...
                // result comes back here. It will be displayed in a table.
